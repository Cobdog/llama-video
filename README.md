...
The patch targets llama.cpp commit `0adede8`. If master has moved forward and the patch fails, pin to this commit.
...
git apply --check /path/to/patches/video-support-20260424.patch  # Dry run to see conflicts
```
